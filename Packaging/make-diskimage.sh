...
OPENUP_TOOL=tools/openUp/openUp
...
#instead of using applescript to set the window appearance, (which tends to fail)
#we will force a .DS_Store file into the disk image

cp WindowSettings "${MOUNT_DIR}"/".DS_Store"
